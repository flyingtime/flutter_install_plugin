...
public class SwiftFlutterInstallPlugin: NSObject, FlutterPlugin {
  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(name: "flutter_install_plugin", binaryMessenger: registrar.messenger())
    let instance = SwiftFlutterInstallPlugin()
